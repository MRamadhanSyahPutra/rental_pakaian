        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item" style="text-align: center;">
                        <a class="nav-link @yield('nav-category')" aria-current="page"
                            href="{{ url('admin/category') }}">Category</a>
                    </li>
                    <li class="nav-item" style="text-align: center;">
                        <a class="nav-link @yield('nav-product')" aria-current="page"
                            href="{{ url('admin/products') }}">Product</a>
                    </li>
                    <li class="nav-item" style="text-align: center;">
                        <a class="nav-link" aria-current="page" href="{{ url('admin/peminjaman') }}">Peminjaman</a>
                    </li>
